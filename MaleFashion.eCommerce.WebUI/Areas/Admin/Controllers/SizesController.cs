...
namespace MaleFashion.eCommerce.WebUI.Areas.Admin.Controllers
{
    ...
    public class SizesController : Controller
    {
        ...
        public SizesController(FashionDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("SizeName,Id,CreatedDate,UpdatedDate,DeletedDate")] Size size)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SizeName,Id,CreatedDate,UpdatedDate,DeletedDate")] Size size)
        {
            if (id != size.Id)
            {
                return NotFound();
