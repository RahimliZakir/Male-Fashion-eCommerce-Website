...
namespace MaleFashion.eCommerce.WebUI.Areas.Admin.Controllers
{
    ...
    public class ColorsController : Controller
    {
        ...
        public ColorsController(FashionDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ColorName,Id,CreatedDate,UpdatedDate,DeletedDate")] Color color)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ColorName,Id,CreatedDate,UpdatedDate,DeletedDate")] Color color)
        {
            if (id != color.Id)
            {
                return NotFound();
